...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="privacy-container">
      <button className="privacy-toggle-btn" onClick={togglePrivacy}>
      ...
      {isOpen && (
        <div className="privacy-content">
          ...
          <div className="privacy-sections">
            ...
            <div className="privacy-section">
              <h4>🔐 Personal Information That Northern India Trip Collects</h4>
            ...
            <div className="privacy-section">
              <h4>🌐 Information Collected During Website Browsing</h4>
            ...
            <div className="privacy-section">
              <h4>🛡️ Security & Legal Compliance</h4>
